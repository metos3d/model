...
subroutine metos3dbgc(ny, nx, nu, nb, nd, dt, q, t, y, u, b, d, ndiag, diag)
    ...
    ! NP-DOP model
    call NPDOPmodel(ny, nx, nu, dt, q, t, y(1,1), y(1,2), y(1,3), u, b(1), b(2), d(1,1), d(1,2), ndiag, diag)
...
!   NP-DOP model
!
subroutine NPDOPmodel(n, nz, m, dt, q, t, yN, yP, yDOP, u, phi, sigmaice, z, dz, ndiag, diag)
    implicit none
    ! input variables
    integer :: n, nz, m
